...
class CivitAI_LORA_Loader:
    ...
    def load_lora(self, model, clip, lora_air, lora_name, strength_model, strength_clip, download_chunks=None, download_path=None, extra_pnginfo=None, civitai_api_key=None):
        ...
        if lora_name == 'none':
            ...
            civitai_model = CivitAI_Model(model_id=lora_id, model_version=version_id, model_types=["LORA", "LoCon"], save_path=download_path, model_paths=LORAS, download_chunks=download_chunks, api_key=civitai_api_key)
